...
m_data <- read.csv("origin_data_182.csv")
...
rst2 <- kmeans(v_data, centers=18, iter.max = 1000, nstart = 1, algorithm = c("Hartigan-Wong", "Lloyd", "Forgy", "MacQueen"))


## acceleration & result clustering result
rst3 <- kmeans(t_data, centers=20, iter.max = 1000, nstart = 1, algorithm = c("Hartigan-Wong", "Lloyd", "Forgy", "MacQueen"))


## deceleration & result clustering result
rst4 <- kmeans(s_data, centers=2, iter.max = 1000, nstart = 1, algorithm = c("Hartigan-Wong", "Lloyd", "Forgy", "MacQueen"))


## compliance & result clustering result
rst5 <- kmeans(k_data, centers=3, iter.max = 1000, nstart = 1, algorithm = c("Hartigan-Wong", "Lloyd", "Forgy", "MacQueen"))


## acceleration & result clustering result
rst6 <- kmeans(o_data, centers=2, iter.max = 1000, nstart = 1, algorithm = c("Hartigan-Wong", "Lloyd", "Forgy", "MacQueen"))


## deceleration & result clustering result
rst7 <- kmeans(u_data, centers=3, iter.max = 1000, nstart = 1, algorithm = c("Hartigan-Wong", "Lloyd", "Forgy", "MacQueen"))
...
origin <- read.csv("cluster_origin.csv")
...
origin <- read.csv("cluster_origin.csv")                         # 2000,  7
